...
| 항목 | 값 | 출처 | 기준 | 비고 |
|---|---|---|---|---|
| **최종 피해면적** | **99,289 ha** | 산림청 / 경상북도 | 최종 | 1986년 산불 통계 작성 이래 최대 |
| 사망 | 26명 | 중대본 | 최종 | 그중 **영덕 10명** — 아래 주 참조 |
| **주택 피해** | **3,819동** | 산림청 / 경상북도 | 최종 | |
| 이재민 | 2,246세대 3,587명 | 경상북도 | 최종 | |
| 총 피해액 | 1조 505억 원 | 경상북도 | 최종 | |
| *(참고) 경북 잠정 면적* | *45,157 ha* | *중앙재난안전대책본부* | *2025-03-27* | **잠정치.** 주불 진화 하루 전 경북 도내 집계이며 최종값이 아니다 |
| *(참고) 주택 전소 잠정* | *150동* | *산림청* | *2025-03-26* | **잠정치.** 진화 이틀 전 집계 |

**영덕 사망자 주.** 10명은 영덕군 공지(2025-04-29)를 그린피스 「2025 영남 초대형 산불
피해 실태조사 최종보고서」 p.9가 인용한 **재인용값**이며, 그린피스의 조사 결과가 아니다.
저장소 내 정본은 `docs/evidence/greenpeace_2026_survey.md` §7 항목 1이다.

### B. 2025년 3월 전국 동시다발 산불 (347건 전체) — 대상 사건이 **아님**

| 항목 | 값 | 출처 | 기준일 |
|---|---|---|---|
| 피해면적 | 104,788 ha | 산림청 | 2025-05-15 |
| 사망 | 32명 | 산림청·언론 종합 | 2025-05-15 |
| 주택 피해 | 3,848동 | 산림청 | 2025-05-15 |

**A와 B의 관계:** A는 B의 약 **95 %**(99,289 / 104,788 ha)다. A를 B와 대비시켜 "전국
수치는 다른 사건"이라고 쓰면 **틀린다** — 전국 수치는 사실상 이 산불이다.

### 알려진 함정

- **116,000 ha는 어느 범위에도 해당하지 않는다.** 초기 README가 A 문장에 이 값을 썼으나
  전국 합계(104,788 ha)보다도 크다. 폐기.
- **45,157 ha와 150동을 최종값으로 쓰지 말 것.** 둘 다 진화 전 잠정치다. 최종값은
  99,289 ha와 3,819동. 2026-09-04 커밋 `12b8ac7`이 잠정치를 최종값으로 적고 "전국
  104,788 ha는 다른 사건"이라는 **반대 방향으로 틀린** 주석까지 달았다가 critic #4
  F16에 걸렸다. 한 번 과대(116,000), 한 번 과소(45,157)로 같은 문장이 두 번 틀렸다.
- **영덕 사망자는 10명이다.** 8명은 저장소가 `f2eecf9`에서 이미 정정한 옛 값이다.
- **사망 27명은 어느 쪽도 아니다.** A는 26명, B는 32명.
- **"주택 4,000여 채"는 B의 3,848동에 가까운 값**이며 A의 최종 주택 피해는 3,819동이다.
  두 값이 비슷해 섞이기 쉬우니 인용 시 범위를 반드시 밝힌다.
- **WWA "48,000 ha 이상"은 이 화재군의 값이 아니다.** World Weather Attribution 신속연구
  (2025-04-30)가 **한국 남동부(southeastern Korea)** 범위로 제시한 수치다. A의 면적
  근거로 인용하면 안 된다.

...
아니라 크기 바닥과 「신고의 99 %가 목격 신고」라는 통계입니다. 「GK2A가 시간을
...
> 🛑 **근거 없음 — 오늘 이 질문에 파일로 답할 수 없습니다 (백로그 WFG-063).** 이 항목은
> 「답을 외우라」가 아니라 「이 선을 넘지 말라」로 읽으십시오. 아래 ⭕ 문장만 말하고,
> ❌ 문장은 고쳐질 때까지 말하지 마십시오.
>
...
> (경향신문 2023-04-28) 임을 보였고 부스 카드에서 삭제되었으며, §10 은 `:310` 에서 그
...
두었습니다. 그 자리에 무엇이 일차로 와야 하는가는 — 실무상 119·마을 무전이겠습니다만 —
저희가 **측정한 것이 아닙니다.**"

❌ **말하면 안 되는 것:** 「사람 신고가 더 빠릅니다」, 「신고의 99 %가 목격 신고이므로」,
「사람 신고를 일차로 두어야 합니다」. 앞의 둘은 등록된 근거가 없고, 셋째는 저장소가
증명하지 않은 결론입니다.

근거: `docs/detection_floor.md` §9 (크기 바닥, 살아남는 결론) 과 `:310` (99 % 금지),
...
| 질문 | 왜 닿지 않는가 | 백로그 |
|---|---|---|
| **Q10d · T0** 「왜 사람 신고를 *일차* 소스로 두십니까?」 | 크기 바닥은 위성을 배제할 뿐 사람을 옹립하지 않고, 그 자리를 메우던 99 % 통계는 미등록 잠정치로 판정되어 금지되었습니다 | WFG-063 |

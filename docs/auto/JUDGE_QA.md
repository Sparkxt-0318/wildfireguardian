...
| 2 | 대조표(`docs/submission_reconciliation.md`) | 순서대로, 종이 없이 — ⚠ 종이가 **없어서**가 아니라, 2026-09-07T0032Z 빌드부터 인쇄물 안에 있는데도 외워서 말하기 위해서입니다. 문서 스스로는 「그 자리에서 펴는 종이」라고 말합니다(WFG-130). 외워서 말하고, 심사위원이 따라오려 하면 그때 폅니다 |

...
- **Claim.** The project's route-existence contribution is more defensible stated as a *difference from* connected-component accessibility analysis (Opanasopit & Louis 2026) than as an unsituated construction: static severance under a post-event footprint versus time-dependent severance under a moving forecast field.  <!-- forbidden-ok: wc022-forecast-field -->

...
| `paper/make_figures.py:134`, `:689` | F3 and F8 legends — bare class labels, same form as the header; kept, and **not** regenerated (§5) |
| `paper/make_figures.py:213`, `:214`, `:242`, `:244` | this lap's own `F5b` docstring, comment and new legend |
| **`README.md:25`, `:798`** | ⛔ 「**2** have no safe walking route **at all**」 — the project's front door, in its own voice, **stronger** than the Abstract wording just repaired. **Outside CHARTER §12**: this routine cannot edit `README.md`. **Filed, not fixed**, and it is the largest live instance of this class |

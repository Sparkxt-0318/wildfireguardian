...
**고원이 아니라 뾰족한 봉우리**입니다」 — the 1 km buffer width is a sharp peak and not a plateau —
...
|---|---|---|
| `README.md:232` | 「고원이 아니라 뾰족한 봉우리」 | **asserts the shape** (new in this diff) |
| `docs/present_perimeter_arm.md:129` | 「The 1 km row is a **spike, not a plateau**」 | **asserts the shape** |
...
English**. WFG-127's root is the second half of that: `:177-191` reads 「spike, not a plateau」;

...
def build(stamp: str, out_dir: Path, preview_dir: Path | None = None) -> dict:
    ...
    manifest = {
        ...
        "what_this_does_not_show": (
            ...
            "scripts/generate_dispatch_outputs.py rebuilds them). The reason "
            "this manifest carried before 20260907T0705Z asserted instead that "
            "they were finished PDFs needing only a printer, which was untrue "
            "of 30 of the 33; it is registered as WC-006 in "
            "docs/auto/withdrawn_claims.json and is deliberately NOT restated "
            "here, because this file is .json and the registry scans .md and "
            ".html, so a quotation on this line could never be licensed by a "
            "pragma and would ride to the booth unreadable by the gate "
            "(WFG-155). R7's own line also carried a count of sheets that "
            "matches no artifact in this repository; that wording is corrected "
            "in the same lap (WFG-153). "

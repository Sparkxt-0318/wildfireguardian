...
BAND = (
    ...
    "not symmetric — the LEFT edge is a cliff (500 m to 750 m gains 65 origins) "
    "and the right side decays gradually (1 km to 1.5 km loses 40), so an "
    "operator who guesses 250 m too THIN loses far more than one who guesses "
    "500 m too THICK, which is an operationally different statement from "
    "「you cannot know」; (3) 750 m scores HIGHER than the 1 km the committed "

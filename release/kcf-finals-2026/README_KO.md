...
> ⚠ **이 문서에서 `docs/...`, `scripts/...`, `outputs/...` 처럼 backtick 으로 적힌 경로는
> 이 폴더가 아니라 저장소 안의 경로입니다.** 이 폴더에 실제로 들어 있는 파일은 아래
> 「이 꾸러미가 무엇인가」 표에 적힌 것이 전부이고, 나머지는 여기서 열리지 않습니다.
> 저장소 주소는 **https://github.com/Sparkxt-0318/wildfireguardian** 이며, 이 꾸러미가
> 만들어진 브랜치는 `auto/dev` 입니다. 부스 노트북에는 복제본이 있으므로 그곳에서는
> 모두 열립니다 (`docs/auto/finals/BOOTH_SETUP.md` §1).

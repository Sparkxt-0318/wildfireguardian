...
PACKAGE_TREE: list[str] = [
    ...
    "wildfireguardian.spread_model.wind",
    "wildfireguardian.spread_model.interaction",
    "wildfireguardian.spread_model.empirical_interaction",
    "wildfireguardian.spread_model.topo_wind",
    "wildfireguardian.spread_model.crown_fire",
    "wildfireguardian.spread_model.spotting",
    "wildfireguardian.spread_model.regime",
    "wildfireguardian.routing.future_front",
